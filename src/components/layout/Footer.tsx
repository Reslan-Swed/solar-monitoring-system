...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-auto border-t border-slate-200 bg-white/50 backdrop-blur-sm py-8 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          <p className="flex items-center gap-2 text-slate-600 font-bold">
            Developed with <Heart className="w-4 h-4 text-rose-500 fill-rose-500 animate-pulse" /> by <span className="text-slate-900">Reslan</span>
          </p>
        ...
        <div className="flex flex-col items-center md:items-end gap-1">
          ...
          <a 
            ...
            className="text-sm text-slate-900 font-bold hover:text-amber-600 transition-colors"
          >
