          ...
          {step === 'info' && (
            ...
            >
              <div className="text-center space-y-2">
                ...
                <p className="text-slate-500 font-medium">Join the solar management network</p>
              </div>
              ...
              <form onSubmit={handleInfoSubmit} className="space-y-4">
                <div className="space-y-4">
                  ...
                  <div className="relative group">
                    <UserCircle className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-amber-500 transition-colors" />
                    <input
                      required
                      type="text"
                ...
                <button
                  disabled={isLoading}
                  type="submit"
                  className="w-full bg-slate-900 text-white py-4 rounded-2xl font-black flex items-center justify-center gap-2 hover:bg-slate-800 transition-all shadow-xl shadow-slate-200 disabled:opacity-50"
                >
                  {isLoading ? (
          ...
          {step === 'otp' && (
            ...
            >
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-slate-500 font-medium">We sent a 6-digit code to {formData.mail}</p>
              </div>
          ...
          {step === 'success' && (
            ...
            >
              ...
              <div className="space-y-2">
                <h1 className="text-3xl font-black text-slate-900 tracking-tight">Welcome Aboard!</h1>
                <p className="text-slate-500 font-medium">Your account has been created successfully.</p>
              </div>
              <button
                onClick={onSuccess}
                className="w-full bg-slate-900 text-white py-4 rounded-2xl font-black flex items-center justify-center gap-2 hover:bg-slate-800 transition-all shadow-xl shadow-emerald-100"
              >
                Go to Login
              </button>
            </motion.div>
